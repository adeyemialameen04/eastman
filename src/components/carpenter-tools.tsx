          ...
          <div key={index} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex">
                ...
                <div className="w-full flex flex-col justify-between">
                  <div className=" w-full flex items-start justify-evenly">
                    {item.sizes.gms.map((size: number, index: number) => (
                      <React.Fragment key={index}>
                        <span className="pt-2 text-xs font-bold">{size}</span>
                        {index !== item.sizes.gms.length - 1 && (
                  ...
                  <div className=" w-full flex items-start overflow-hidden pt-2 border-t border-t-[#ddd] justify-evenly">
                    {item.sizes.ibs.map((size: number, index: number) => (
                      <React.Fragment key={index}>
              ...
              <div className="flex">
                ...
                <div className={cn("w-full", item.toOrder === "" && "hidden")}>
...
export default PaginatedCarpenterTools;
